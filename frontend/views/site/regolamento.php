      ...
      <div class="row">
         <div class="col">
            <div id="regolamento" class="page-content mt-5">
               ...
               <p>I punti si accumulano inviando la foto dello scontrino comprovante l’acquisto dei prodotti partecipanti alla raccolta. Ogni scontrino può essere inviato una ed una sola volta. In caso di invio dello stesso scontrino più volte l’azienda promotrice si riserva la facoltà di escludere il partecipante dalla raccolta punti con l’azzeramento dei punti eventualmente accumulati. Nel caso in cui lo stesso scontrino sia inviato da più partecipanti, l’azienda si riserva la facoltà di escludere tutti i soggetti coinvolti.</p>
               <p>Per essere valido, lo scontrino fiscale deve contenere necessariamente i seguenti elementi:</p>
               <ol>
                  <li>
                    La ragione sociale, partita iva, indirizzo del luogo di acquisto del prodotto;
                  </li>
                  <li>
                    Il numero dello scontrino fiscale;
                  </li>
                  <li>
                    Il numero univoco <em>RT</em>;
                  </li>
                  <li>
                    La data e l’ora di acquisto;
                  </li>
                  <li>
                    Il prodotto/i del [NOME DEL BRAND] partecipante/i all’iniziativa.
                  </li>
               </ol>
               <p>In mancanza di uno solo degli elementi sopra elencati, lo scontrino non sarà considerato valido per l’accumulo punti.</p>
               ...
               <ul>
                  <li>
                    gestione della raccolta punti;
                  </li>
                  <li>
                    invio di comunicazioni promozionali e commerciali relative ai prodotti e servizi del brand [Nome del brand] e di altre aziende del gruppo;
                  </li>
                  <li>
                    elaborazione di studi di mercato e analisi di dati a fini statistici e di profilazione di marketing.
                  </li>
               </ul>
               <p>Il trattamento dei dati personali avverrà con modalità informatiche e/o telematiche, con strumenti idonei a garantire la sicurezza e la riservatezza dei dati stessi, e sarà effettuato dal personale del brand e da eventuali responsabili esterni nominati dal brand.</p>
               <p>Il conferimento dei dati personali è necessario per partecipare alla raccolta punti e per ricevere le relative comunicazioni commerciali e promozionali. L'eventuale rifiuto di fornire i dati personali comporterà l'impossibilità di partecipare alla raccolta punti e di ricevere le comunicazioni commerciali e promozionali.</p>
               <p>I dati personali dell'utente potranno essere comunicati a terzi, quali fornitori di servizi tecnologici, di elaborazione dati e di assistenza, per il corretto svolgimento delle attività connesse alla raccolta punti e alle finalità di profilazione di marketing.</p>
               <p>In ogni momento, l'utente potrà esercitare i diritti previsti dal GDPR, tra cui:</p>
               <ul>
                  <li>
                    diritto di accesso ai propri dati personali;
                  </li>
                  <li>
                    diritto di rettifica, cancellazione e limitazione del trattamento dei propri dati personali;
                  </li>
                  <li>
                  ...
                  <li>
                    diritto di revocare il consenso al trattamento dei propri dati personali.
                  </li>
               </ul>
               <p>Per esercitare tali diritti o per ricevere informazioni sul trattamento dei propri dati personali, l'utente potrà contattare il brand tramite l'apposita sezione del sito web o inviando una comunicazione scritta all'indirizzo [Indirizzo del brand].</p>
            </div>
         </div>
      </div>
   </div>
