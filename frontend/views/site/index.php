    ...
    <div class="body-content">
        <div class="row">
            <div class ="col-md-6 col-xs-12 col-sm-12">
                <div class="bg-profility-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
                <div class="my-3 py-3">
                    <h2 class="display-5">Premio 1</h2>
                    <p class="lead">Aggiudicati il premio con 150 punti.</p>
                </div>
            ...
            <div class="col-md-6 col-xs-12 col-sm-12">
                <div class="bg-profility-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                    ...
                    <p class="lead profility-color">Aggiudicati il premio con 300 punti.</p>
                </div>
